...
创建页面最重要的 d2-container 组件进行了重构，详见 [页面容器](https://fairyever.com/d2-admin/doc/zh/components/container.html)，依旧是支持 `full` + `card` + `ghost` 三种模式，不同的是三种模式现在都分别支持 `header` 和 `footer` 插槽，并且都支持开关自定义滚动条，并且提供了滚动条设置的 props。
...
在 [页面容器](https://fairyever.com/d2-admin/doc/zh/components/container.html) 文档中我也分别为三种模式 x 是否有插槽 x 是否启用滚动条优化的各种可能做了大量插图介绍，欢迎去文档站点查看。

![](https://qiniucdn.fairyever.com/20180723083604.png?imageMogr2/auto-orient/thumbnail/1480x/blur/1x0/quality/100|imageslim)

在线示例（请先完成一次登录）

* [布局容器](https://fairyever.com/d2-admin/preview/#/demo/components/container/full)
...
详见 [VUEX 实用工具](https://fairyever.com/d2-admin/doc/zh/plugins/vuex.html)
...
* [菜单控制](https://fairyever.com/d2-admin/preview/#/demo/playground/store/menu)
...
详见 [Util 实用工具](https://fairyever.com/d2-admin/doc/zh/plugins/util.html)
...
* [用户数据](https://fairyever.com/d2-admin/preview/#/demo/playground/db/user)
* [公用数据](https://fairyever.com/d2-admin/preview/#/demo/playground/db/public)
...
详见 [快速上手](https://fairyever.com/d2-admin/doc/zh/guide/getting-started.html)
...
[被 "借鉴" 总是不愉快的](https://fairyever.com/d2-admin/doc/zh/guide/plagiarize.html)
...
| [完整版 预览地址](https://fairyever.com/d2-admin/preview/#/index) | 完整版 预览地址 |
